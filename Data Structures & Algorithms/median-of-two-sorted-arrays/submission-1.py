class Solution:
    def findMedianSortedArrays(self, nums1: List[int], nums2: List[int]) -> float:
        ...
        We want to split both sorted arrays into a left half and right half
        such that:
        ...
        And the len addition of both halves of the two arrays is roughly same.
        ...
        while l <= r:
            ...
            # Correct partition:
            # everything on the left side is <= everything on the right side.
